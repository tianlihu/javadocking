...
/**
 * This example shows a split dock with two tab docks as children.
 *
 * @author Heidi Rakels
 */
public class SplitDockWithTwoChildren extends JPanel {
    ...
    public SplitDockWithTwoChildren(JFrame frame) {
...
//		// Add the child docks to the split dock at the top and bottom.
...
//            setBorder(BorderFactory.createLineBorder(Color.lightGray));
    ...
    public static void main(String[] args) {
        ...
        SplitDockWithTwoChildren panel = new SplitDockWithTwoChildren(frame);
