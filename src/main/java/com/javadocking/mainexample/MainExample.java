package com.javadocking.mainexample;
 ...
 * @author Heidi Rakels
 */
public class MainExample extends JPanel {
    ...
    public MainExample(JFrame frame) {
        ...
        // Add the button dockables to the grid dock.
        ...
        toolGridDock.addDockable(buttonDockables[29], new Position(9));
        toolGridDock.addDockable(buttonDockables[30], new Position(10));
        toolGridDock.addDockable(buttonDockables[31], new Position(11));
        toolGridDock.addDockable(buttonDockables[32], new Position(12));
        toolGridDock.addDockable(buttonDockables[33], new Position(13));
        toolGridDock.addDockable(buttonDockables[34], new Position(14));
        toolGridDock.addDockable(buttonDockables[35], new Position(15));
        toolGridDock.addDockable(buttonDockables[36], new Position(16));
    ...
    public static void createAndShowGUI() {
        ...
        LAFS = new LAF[8];
        LAFS[0] = new LAF("FlatLAF", "com.formdev.flatlaf.FlatDarculaLaf", LAF.THEME_DEAULT);
        LAFS[1] = new LAF("Substance", "org.jvnet.substance.skin.SubstanceModerateLookAndFeel", LAF.THEME_DEAULT);
        LAFS[2] = new LAF("Mac", "javax.swing.plaf.mac.MacLookAndFeel", LAF.THEME_DEAULT);
        LAFS[3] = new LAF("Metal", "javax.swing.plaf.metal.MetalLookAndFeel", LAF.THEME_DEAULT);
        LAFS[4] = new LAF("Liquid", "com.birosoft.liquid.LiquidLookAndFeel", LAF.THEME_DEAULT);
        LAFS[5] = new LAF("Windows", "com.sun.java.swing.plaf.windows.WindowsLookAndFeel", LAF.THEME_DEAULT);
        LAFS[6] = new LAF("Nimbus", "javax.swing.plaf.nimbus.NimbusLookAndFeel", LAF.THEME_OCEAN);
        LAFS[7] = new LAF("TinyLaF", "de.muntjak.tinylookandfeel.TinyLookAndFeel", LAF.THEME_DEAULT);
        ...
        MainExample panel = new MainExample(frame);
